...
1. Teleport user creates a new role, `cloud-cluster-editor`, that gives access to creating and modifying `workload_cluster` resources.
...
1. Teleport user sets up a new Go project.
   ...
   go get github.com/gravitational/teleport/api/client@9c74daa387b2b08381ff160e790b2e7cdec1a8bf
   ```
