...
func TestClientListLinuxDesktops(t *testing.T) {
	...
	desktops, next, err := client.ListLinuxDesktops(context.Background(), 10, "token")
...
func TestClientCreateLinuxDesktop(t *testing.T) {
	...
	resp, err := client.CreateLinuxDesktop(context.Background(), desktop)
	require.NoError(t, err)
...
func TestClientGetLinuxDesktop(t *testing.T) {
	...
	resp, err := client.GetLinuxDesktop(context.Background(), "desktop-1")
	require.NoError(t, err)
...
func TestClientUpdateLinuxDesktop(t *testing.T) {
	...
	resp, err := client.UpdateLinuxDesktop(context.Background(), desktop)
	require.NoError(t, err)
	require.Equal(t, desktop, resp)
...
func TestClientUpsertLinuxDesktop(t *testing.T) {
	...
	resp, err := client.UpsertLinuxDesktop(context.Background(), desktop)
	require.NoError(t, err)
	require.Equal(t, desktop, resp)
...
func TestClientDeleteLinuxDesktop(t *testing.T) {
	...
	err := client.DeleteLinuxDesktop(context.Background(), "desktop-1")
	require.NoError(t, err)
