...
const (
	...
	AuthService_DeleteClusterAlerts_FullMethodName                 = "/proto.AuthService/DeleteClusterAlerts"
...
type AuthServiceClient interface {
	...
	// DeleteClusterAlerts deletes a cluster alert.
	DeleteClusterAlerts(ctx context.Context, in *DeleteClusterAlertRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
...
func (c *authServiceClient) DeleteClusterAlerts(ctx context.Context, in *DeleteClusterAlertRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, AuthService_DeleteClusterAlerts_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type AuthServiceServer interface {
	...
	// DeleteClusterAlerts deletes a cluster alert.
	DeleteClusterAlerts(context.Context, *DeleteClusterAlertRequest) (*emptypb.Empty, error)
	// CreateAlertAck marks a cluster alert as acknowledged.
...
func (UnimplementedAuthServiceServer) DeleteClusterAlerts(context.Context, *DeleteClusterAlertRequest) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DeleteClusterAlerts not implemented")
}
...
func _AuthService_DeleteClusterAlerts_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DeleteClusterAlertRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(AuthServiceServer).DeleteClusterAlerts(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: AuthService_DeleteClusterAlerts_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).DeleteClusterAlerts(ctx, req.(*DeleteClusterAlertRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AuthService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "DeleteClusterAlerts",
			Handler:    _AuthService_DeleteClusterAlerts_Handler,
		},
		{
