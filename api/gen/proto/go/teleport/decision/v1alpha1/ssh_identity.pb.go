...
type SSHIdentity struct {
	...
	ImmutableLabelHash string `protobuf:"bytes,37,opt,name=immutable_label_hash,json=immutableLabelHash,proto3" json:"immutable_label_hash,omitempty"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
const file_teleport_decision_v1alpha1_ssh_identity_proto_rawDesc = "" +
	...
	"\x0eauthority_type\x18\x02 \x01(\tR\rauthorityType\"\xc2\f\n" +
