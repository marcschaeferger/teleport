...
export function NotConfiguredSelfHosted() {
  return (
    <StoryContainer>
      <ManagedUpdates />
    </StoryContainer>
...
NotConfiguredSelfHosted.parameters = {
  msw: {
    handlers: [
      http.get(cfg.getManagedUpdatesUrl(), () => {
...
ActionLoading.parameters = {
  msw: {
    handlers: [
      ...
      http.post(
        '/v1/webapi/managed-updates/groups/:groupName/:action',
        async () => {
          await delay('infinite');
          return HttpResponse.json({});
        }
...
ActionError.parameters = {
  msw: {
    handlers: [
      ...
      http.post('/v1/webapi/managed-updates/groups/:groupName/:action', () => {
        return HttpResponse.json(
