...
This key is then reused as the pagination token. With the following considerations:
1. Compound keys should use `"/"` as the separator.
2. Keys should be lexicographically ordered for a given index.
   1. For compound keys, consider order of components for the purpose of sorting.
   2. Timestamps should make use of RFC3339 format.
   3. Numerical components should consider zero padding.
