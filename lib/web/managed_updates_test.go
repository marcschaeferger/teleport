...
func TestGetManagedUpdatesDetails(t *testing.T) {
	...
	// Make the request
	resp, err := pack.clt.Get(ctx, pack.clt.Endpoint("webapi", "managed-updates"), url.Values{})
	require.NoError(t, err)
...
func TestStartGroupUpdate(t *testing.T) {
	...
	// Start the update
	resp, err := pack.clt.PostJSON(ctx, pack.clt.Endpoint("webapi", "managed-updates", "groups", "dev", "start"), nil)
	require.NoError(t, err)
	...
	resp, err = pack.clt.PostJSON(ctx, pack.clt.Endpoint("webapi", "managed-updates", "groups", "staging", "start"), ui.StartGroupUpdateRequest{
		Force: true,
	})
	require.NoError(t, err)
	...
	_, err = pack.clt.PostJSON(ctx, pack.clt.Endpoint("webapi", "managed-updates", "groups", "nonexistent", "start"), nil)
	require.Error(t, err)
}
...
func TestMarkGroupDone(t *testing.T) {
	...
	resp, err := pack.clt.PostJSON(ctx, pack.clt.Endpoint("webapi", "managed-updates", "groups", "dev", "start"), ui.StartGroupUpdateRequest{
		Force: true,
	})
	require.NoError(t, err)
	...
	resp, err = pack.clt.PostJSON(ctx, pack.clt.Endpoint("webapi", "managed-updates", "groups", "dev", "done"), nil)
	require.NoError(t, err)
	...
	_, err = pack.clt.PostJSON(ctx, pack.clt.Endpoint("webapi", "managed-updates", "groups", "nonexistent", "done"), nil)
	require.Error(t, err)
}
...
func TestRollbackGroup(t *testing.T) {
	...
	// Force-start the group
	resp, err := pack.clt.PostJSON(ctx, pack.clt.Endpoint("webapi", "managed-updates", "groups", "prod", "start"), ui.StartGroupUpdateRequest{
		Force: true,
	})
	require.NoError(t, err)
	...
	// Rollback the group
	resp, err = pack.clt.PostJSON(ctx, pack.clt.Endpoint("webapi", "managed-updates", "groups", "prod", "rollback"), nil)
	require.NoError(t, err)
	...
	_, err = pack.clt.PostJSON(ctx, pack.clt.Endpoint("webapi", "managed-updates", "groups", "nonexistent", "rollback"), nil)
	require.Error(t, err)
}
