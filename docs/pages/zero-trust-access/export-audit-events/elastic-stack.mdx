...
## Step 1/5. Install the Event Handler plugin
...
## Step 2/5. Configure the Event Handler plugin
...
## Step 3/5. Configure a Logstash pipeline
...
## Step 4/5. Run the Event Handler plugin
...
If you are using the `teleport-plugin-event-handler`
Helm chart with Teleport Kubernetes Operator enabled, you can ignore the below step, as we
...
## Step 5/5. Create a data view in Kibana
